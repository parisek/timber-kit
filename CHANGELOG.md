...
- **`StarterBase::$admin_bar_options_link` flag (bool, default `true`)** — adds a "Theme Settings" shortcut to the WordPress admin bar (under the site name) linking to the first top-level options page. Set `false` to omit it.
