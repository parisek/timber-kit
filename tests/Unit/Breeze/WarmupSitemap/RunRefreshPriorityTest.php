...
class RunRefreshPriorityTest extends TestCase {
	...
	public function test_menu_pages_outrank_plain_pages(): void {
		...
		$built = WarmupSitemap::buildOrderedUrls( $records, Scorer::DEFAULT_WEIGHTS, 1000000000, 50 );
	...
	public function test_cap_is_applied(): void {
		...
		$built = WarmupSitemap::buildOrderedUrls( $records, Scorer::DEFAULT_WEIGHTS, 1000000000, 3 );
